  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        />
        <!-- enter式按键的修饰符，native也是修饰符监听原生时间 -->
...
export default {
  name: 'Login',
  data() {
    const validateMbile = (rule, value, callback) => {
      // if (!validMbile(value)) {
      //   callback(new Error('请输入正确的手机号'))
      // } else {
      //   callback()
      // }
      validMbile(value) ? callback() : callback(new Error('请输入正确的手机号'))
    }
    ...
    return {
      ...
      loginRules: {
        mobile: [{ required: true, trigger: 'blur', message: '手机号不能为空' }, { validator: validateMbile, trigger: 'blur' }],
